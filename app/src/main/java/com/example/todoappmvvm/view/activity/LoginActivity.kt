...
import com.example.todoappmvvm.Objects
...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button_edt_enter.setOnClickListener {
            if (username_edt_enter.text.toString().isNotEmpty() && password_edt_enter.text.toString().isNotEmpty()){
        ...
        mainViewModel.signInResponse.observe(this, Observer {
            ...
            /*if (it.token==null){
                Toast.makeText(LoginActivity@this,"Вы не зарегистрированы",Toast.LENGTH_LONG).show()
            }*/
        })
